...
const EDUCATIONAL_TOURS: Record<string, Record<string, string[]>> = {
  'History Tour': {
    ...
    'Harties': ['Harties Dam Heritage Tour', 'Old Crocodile River Trading Post Walk'],
    'Brits': ['Harties Heritage Trail', 'Early Settlers Museum Visit'],
  ...
  'Geography Tour': {
    ...
    'Harties': ['Harties Dam Geography Tour', 'Magaliesberg Mountain Formation Walk'],
