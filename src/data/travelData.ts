...
const premiumHotelNames: Record<string, { name: string; includesBreakfast?: boolean; capacity?: '2_sleeper' | '4_sleeper'; nightlyRate?: number }[]> = {
  ...
  'cape-town': [
    ...
    { name: 'Southern Sun Waterfront', includesBreakfast: true },
    { name: 'President Hotel' },
    { name: 'The Bay Hotel' },
    { name: 'Twelve Apostles Hotel & Spa', includesBreakfast: true },
    { name: 'Protea Hotel Sea Point', includesBreakfast: true },
    { name: 'The Marly' },
  ],
  'sun-city': [
    ...
    { name: "Getty's Bed and Breakfast", includesBreakfast: true },
  ...
  'mpumalanga': [
    ...
    { name: 'Lush' },
    { name: 'Panorama Villa' },
    { name: 'Beach Island Graskop' },
    { name: 'Panorama Boutique Guesthouse' },
    { name: 'Angels View Hotel' },
    { name: 'Blyde Canyon Forever Resort' },
    { name: 'Amafu Forest Lodge' },
    { name: 'Blyde Mountain Lodge' },
  ],
  'knysna': [
  ...
  'vaal-river': [
    { name: 'Riviera on the Vaal' },
    { name: 'Clivia Lodge' },
    { name: 'Troas Boutique Hotel' },
    { name: '12 On Vaal Drive Guesthouse' },
    { name: 'Casa Angelo' },
  ],
  'bela-bela': [
